  ...
  while (running) {
    ...
    try {
      ...
      for (const ws of allActive) {
        ...
        } else if (["creating", "claimed", "planning", "grilling", "plan_reviewing", "awaiting_feedback", "waiting_for_answer", "coding", "testing", "reviewing", "rebasing", "creating_pr", "merging", "pr_open"].includes(ws.status)) {
