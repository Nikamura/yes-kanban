...
describe("migrations infrastructure", () => {
  test("runAll serial order: backfills and removeDisableBuiltInMcp are appended in order", () => {
    ...
    expect(order[3]).toEqual(internal.migrations.removeDisableBuiltInMcp);
  });
